...
Route::get('/dashboard/snapshot', [DashboardController::class, 'dashboardFeasibility'])->name('dashboard.snapshot');
// Route::get('/dashboard/academic-planner', [AcademicPlannerController::class, 'index'])->name('dashboard.academic-planner');
